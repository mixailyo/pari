...
/* harmony import */ var _modules_welcome__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/welcome */ "./js/modules/welcome.js");
/* harmony import */ var _modules_line__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/line */ "./js/modules/line.js");
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
/* harmony import */ var _modules_friends__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/friends */ "./js/modules/friends.js");
/* harmony import */ var _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/select/custom-select */ "./js/modules/select/custom-select.js");
/* harmony import */ var _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/form-validate/form */ "./js/modules/form-validate/form.js");
/* harmony import */ var _modules_ambassadors__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/ambassadors */ "./js/modules/ambassadors.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_welcome__WEBPACK_IMPORTED_MODULE_3__["welcomeInit"])();
  Object(_modules_line__WEBPACK_IMPORTED_MODULE_4__["lineInit"])();
  Object(_modules_news__WEBPACK_IMPORTED_MODULE_10__["newsInit"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_5__["initAccordions"])();
    Object(_modules_friends__WEBPACK_IMPORTED_MODULE_6__["friendsInit"])();
    Object(_modules_ambassadors__WEBPACK_IMPORTED_MODULE_9__["ambassadorsInit"])();
    var select = new _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_7__["CustomSelect"]();
    select.init();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_8__["Form"]();
    window.form = form;
    form.init();
  });
});
...
/***/ "./js/modules/ambassadors.js":
/*!***********************************!*\
  !*** ./js/modules/ambassadors.js ***!
  \***********************************/
/*! exports provided: ambassadorsInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ambassadorsInit", function() { return ambassadorsInit; });
function ambassadorsInit() {
  var swiper1 = new Swiper('.ambassadors__slider:not(.ambassadors__slider--main)', {
    loop: true,
    // Navigation arrows
    navigation: {
  ...
  var swiper2 = new Swiper('.ambassadors__slider--main', {
    loop: true,
    // Navigation arrows
    navigation: {
      nextEl: '.ambassadors__navigation-btn--next',
...
/*!*******************************!*\
  !*** ./js/modules/friends.js ***!
  \*******************************/
/*! exports provided: friendsInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "friendsInit", function() { return friendsInit; });
function friendsInit() {
  var friendsSlider = document.querySelector('.friends__slider');
  if (friendsSlider) {
    var swiper = new Swiper(friendsSlider, {
      navigation: {
...
function headerInit() {
  ...
  var headerMini = document.querySelector('.header--mini');
  if (headerHumburger) {
...
function lineInit() {
  var marqueeContainers = document.querySelectorAll(".marquee-container");
  marqueeContainers.forEach(function (marqueeContainer) {
    var line = marqueeContainer.parentNode;
    for (var i = 0; i < 200; i++) {
      var clone = marqueeContainer.cloneNode(true);
      line.appendChild(clone);
    }
    var transform = 1;
    transform = transform + 1;
    line.style.transform = "translateX(calc(".concat(transform, " * 100vw * -1))");
...
/*!****************************!*\
  !*** ./js/modules/news.js ***!
  \****************************/
/*! exports provided: newsInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newsInit", function() { return newsInit; });
function newsInit() {
  var news = document.querySelector('.news');
  if (news) {
    var newsMore = document.querySelector('.news__more');
...
/*!*******************************!*\
  !*** ./js/modules/welcome.js ***!
  \*******************************/
/*! exports provided: welcomeInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "welcomeInit", function() { return welcomeInit; });
function welcomeInit() {
  var welcomeToggler = document.querySelector('.welcome__toggler');
  if (welcomeToggler) {
    welcomeToggler.addEventListener('click', function () {
      var welcomeWrapper = document.querySelector('.welcome__wrapper');
